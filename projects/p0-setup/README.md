...
> ✅ **완료 (2026-08-27)** — Blink, 시리얼 hello 둘 다 확인. 다음은 p1(모터 구동).

- `src/blink_test/` — LED 블링크 (빌드→플래싱→디버깅 완주 확인). 실험 코드는 `app_main.c` 하나
- `src/uart_hello/` — 시리얼 "hello" ✅. USART2(PB3/PB4) → ST-LINK VCP, 115200 8N1
- `data/` — (이 단계에선 없음)
...
- [2026-08-20 실습 준비 및 이론 공부](../../log/2026-08-20-motor-anatomy-and-board-bringup.md)
- [2026-08-27 p0 완료 — 시리얼 hello](../../log/2026-08-27-p0-complete-uart-hello.md)
