...
| 엔코더/홀 커넥터 | PB6 (A+/H1), PB7 (B+/H2), PB8 (Z+/H3) | AS5600 연결 후보 — 3.4 참고 |
...
- **PB6/PB7 은 STM32G431 에서 I2C1 로도 쓸 수 있는 핀**이다. AS5600 이 I2C 이므로
  엔코더 커넥터를 그대로 I2C 로 쓸 수 있을 가능성이 높다 —
  **DS12589 의 AF 표로 확인 후** 진행할 것. (아직 미확인)
...
- **AS5600 결선 확인** — 3.4 의 I2C 가능성 확인 후
